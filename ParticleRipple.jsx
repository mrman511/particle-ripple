...
export default function ParticleRipple(props){
  ...
  useEffect(()=>{
    ...
    // console.log(particleGrid.activeClicks);
  }, [animationFrame])


  return (
    <>
      <canvas ref={ canvasRef } className='absolute h-[115%] w-[115%] bg-transparent'></canvas>
      <canvas ref={ staticRef } className='absolute h-[115%] w-[115%] bg-transparent'></canvas>
    </>
  )
}